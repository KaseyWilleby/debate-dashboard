...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/data.ts [app-ssr] (ecmascript)"); // Import static user data
"use client";
;
;
;
...
function AuthProvider({ children }) {
    ...
    // Use the static list of users instead of fetching from Firestore.
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        // Since we are not fetching users, we only depend on the Firebase auth state.
        if (!isUserLoading) {
            setIsLoading(false);
        }
    }, [
    ...
    const login = (credentials)=>{
        ...
        if (userToLogin) {
            ...
            throw new Error('User not found. Try one of the available usernames.');
        }
    };
    const logout = ()=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5cbecb77._.js.map