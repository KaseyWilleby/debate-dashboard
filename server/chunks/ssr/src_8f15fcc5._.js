    ...
    const addContention = ()=>{
        const newContentions = [
            ...caseData.contentions || [],
            {
                ...
                title: `Contention ${(caseData.contentions || []).length + 1}`,
                text: ''
            }
        ];
        setCaseData((prev)=>prev ? {
...
//# sourceMappingURL=src_8f15fcc5._.js.map