...
;
const useUser = ()=>{
    const auth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuthFirebase"])();
...
__turbopack_context__.s({
    ...
    "useAuthFirebase": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuthFirebase"]),
    ...
    "useMemoFirebase": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useMemoFirebase"]),
...
__turbopack_context__.s({
    ...
    "useAuthFirebase": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$exports$3e$__["useAuthFirebase"]),
...
"[project]/src/firebase/non-blocking-login.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function initiateEmailSignUp(authInstance, firestore, email, password, name, role) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$node$2d$esm$2f$totp$2d$18137433$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__ab__as__createUserWithEmailAndPassword$3e$__["createUserWithEmailAndPassword"])(authInstance, email, password).then((userCredential)=>{
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setDoc"])(userDocRef, userData).catch((error)=>{
...
function initiateSignOut(authInstance) {
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$node$2d$esm$2f$totp$2d$18137433$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__D__as__signOut$3e$__["signOut"])(authInstance);
}
}}),
...
function AuthProvider({ children }) {
    ...
    const userDocRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useMemoFirebase"])(()=>firestore && firebaseUser ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["doc"])(firestore, "users", firebaseUser.uid) : null, [
        firestore,
        firebaseUser
    ]);
    ...
    const login = async (credentials)=>{
        if (!auth) return;
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$non$2d$blocking$2d$login$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["initiateEmailSignIn"])(auth, credentials.email, credentials.password || 'password123');
    ...
    const logout = async ()=>{
        if (!auth) return;
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$non$2d$blocking$2d$login$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["initiateSignOut"])(auth);
            setAppUser(null);
            router.push('/');
        } catch (error) {
    ...
    const signUp = async (credentials)=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$non$2d$blocking$2d$login$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["initiateEmailSignUp"])(auth, firestore, credentials.email, credentials.password || 'password123', credentials.name, credentials.role);
            router.push('/dashboard/welcome');
        } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2cb5369d._.js.map