...
const debateResources = allResources.filter((r)=>debateEventsOrder.includes(r.event));
const speechResources = allResources.filter((r)=>[
        'Extemporaneous Speaking',
        'Original Oratory',
        'Informative Speaking'
    ].includes(r.event));
const interpResources = allResources.filter((r)=>interpEventsOrder.includes(r.event));
...
"[project]/src/app/dashboard/learning-hub/interp/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function InterpLearningPage() {
    const events = Array.from(new Set(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$learning$2d$resources$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["interpResources"].map((r)=>r.event)));
    const sortedEvents = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        const allInterpEvents = [
            ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$learning$2d$resources$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["interpEventsOrder"]
        ];
        ...
        return allInterpEvents.filter((event)=>eventSet.has(event));
    }, [
        events
    ]);
...
//# sourceMappingURL=_098816fd._.js.map