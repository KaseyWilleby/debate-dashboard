...
function AuthProvider({ children }) {
    ...
    const { isUserLoading: isFirebaseUserLoading, user: firebaseUser } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useUser"])();
    const { auth } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useFirebase"])();
    ...
    const login = async (userToLogin)=>{
        ...
        if (foundUser) {
            if (auth && !auth.currentUser) {
                try {
                    const userCredential = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$node$2d$esm$2f$totp$2d$18137433$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__a1__as__signInAnonymously$3e$__["signInAnonymously"])(auth);
                    const userWithUid = {
                        ...foundUser,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3a7ebee9._.js.map