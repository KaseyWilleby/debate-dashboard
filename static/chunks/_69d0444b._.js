...
"[project]/src/app/dashboard/learning-hub/standing-rules/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function StandingRulesPage() {
    ...
    const resourcesWithRules = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "StandingRulesPage.useMemo[resourcesWithRules]": ()=>{
            return resources.filter({
                "StandingRulesPage.useMemo[resourcesWithRules]": (r)=>r.rules && (r.rules.NSDA || r.rules.TFA || r.rules.UIL)
            }["StandingRulesPage.useMemo[resourcesWithRules]"]);
        }
    }["StandingRulesPage.useMemo[resourcesWithRules]"], [
        resources
    ...
    const events = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "StandingRulesPage.useMemo[events]": ()=>{
            return [
                ...new Set(resourcesWithRules.map({
                    "StandingRulesPage.useMemo[events]": (r)=>r.event
                }["StandingRulesPage.useMemo[events]"]))
            ];
        }
    }["StandingRulesPage.useMemo[events]"], [
...
_s(StandingRulesPage, "iXGuy2EqsPD0dBMGf35AU6vkZLs=", false, function() {
    return [
...
_c = StandingRulesPage;
var _c;
__turbopack_context__.k.register(_c, "StandingRulesPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_69d0444b._.js.map