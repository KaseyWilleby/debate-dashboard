...
{
__turbopack_context__.v(JSON.parse("{\"placeholderImages\":[{\"id\":\"user1\",\"description\":\"Admin user avatar\",\"imageUrl\":\"https://images.unsplash.com/photo-1521119989659-a83eee488004?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxMHx8cGVyc29uJTIwcG9ydHJhaXR8ZW58MHx8fHwxNzU5NjI0NTg2fDA&ixlib=rb-4.1.0&q=80&w=1080\",\"imageHint\":\"person portrait\"},{\"id\":\"user2\",\"description\":\"Varsity user avatar\",\"imageUrl\":\"https://images.unsplash.com/photo-1542596768-5d1d21f1cf98?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw1fHxwZXJzb24lMjBzbWlsaW5nfGVufDB8fHx8MTc1OTY2MDUwM3ww&ixlib=rb-4.1.0&q=80&w=1080\",\"imageHint\":\"person smiling\"},{\"id\":\"user3\",\"description\":\"Novice user avatar\",\"imageUrl\":\"https://images.unsplash.com/photo-1707946159631-8bf54b026ece?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw4fHxzdHVkZW50JTIwcHJvZmlsZXxlbnwwfHx8fDE3NTk2NTc3NTl8MA&ixlib=rb-4.1.0&q=80&w=1080\",\"imageHint\":\"student profile\"},{\"id\":\"user4\",\"description\":\"Another varsity user avatar\",\"imageUrl\":\"https://images.unsplash.com/photo-1595211877493-41a4e5f236b3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw3fHxwcm9mZXNzaW9uYWwlMjBoZWFkc2hvdHxlbnwwfHx8fDE3NTk2OTA0MTF8MA&ixlib=rb-4.1.0&q=80&w=1080\",\"imageHint\":\"professional headshot\"},{\"id\":\"user5\",\"description\":\"Another novice user avatar\",\"imageUrl\":\"https://images.unsplash.com/photo-1651840760882-e5209bba5815?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw4fHxjYXN1YWwlMjBwb3J0cmFpdHxlbnwwfHx8fDE3NTk2OTMzNDR8MA&ixlib=rb-4.1.0&q=80&w=1080\",\"imageHint\":\"casual portrait\"},{\"id\":\"user6\",\"description\":\"User Mr. Willeby\",\"imageUrl\":\"https://images.unsplash.com/photo-1676972437013-c86eca9b0daa?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw1fHxnZW50bGVtYW4lMjBwb3J0cmFpdHxlbnwwfHx8fDE3NTk3MzM5NzZ8MA&ixlib=rb-4.1.0&q=80&w=1080\",\"imageHint\":\"gentleman portrait\"}]}"));}}),
...
;
;
const findImage = (id)=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$placeholder$2d$images$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PlaceHolderImages"].find((p)=>p.id === id)?.imageUrl || '';
const users = [
    {
        id: '2',
        name: 'Varsity Val',
...
let sessions = [
    {
        ...
        description: 'A beginner-friendly session covering useState, useEffect, and useContext.',
        ...
        messages: [
            {
                id: 'm1',
                senderId: '2',
                content: 'Hey Nick, looking forward to our session!',
                timestamp: new Date(Date.now() - 60000 * 5).toISOString()
            },
            {
                id: 'm2',
                senderId: '3',
                content: 'Me too! I have a few questions prepared.',
    ...
    },
    {
        ...
        description: 'Exploring generics, conditional types, and mapped types in TypeScript.',
        date: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$addDays$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDays"])(new Date(), 1), 'yyyy-MM-dd'),
        time: '02:00 PM',
        hostId: '4',
        clientId: null,
        status: 'available',
    ...
    },
    {
        ...
        description: 'Deep dive into the new Next.js App Router, Server Components, and Layouts.',
        date: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$addDays$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDays"])(new Date(), 2), 'yyyy-MM-dd'),
        time: '11:00 AM',
        hostId: '2',
        clientId: '5',
        status: 'booked',
    ...
    },
    {
        ...
        description: 'Learn the fundamentals of utility-first CSS with Tailwind.',
        date: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$addDays$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDays"])(new Date(), 3), 'yyyy-MM-dd'),
        time: '03:00 PM',
        hostId: null,
        clientId: null,
        status: 'available',
    ...
    },
    {
        ...
        description: 'Comparing different state management libraries and patterns like Redux, Zustand, and Context API.',
        date: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$addDays$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDays"])(new Date(), -1), 'yyyy-MM-dd'),
        time: '01:00 PM',
        hostId: '4',
        clientId: '3',
...
function AuthProvider({ children }) {
    ...
    const login = async (username)=>{
        let allUsers = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["users"];
        try {
            ...
            console.error("Failed to parse users from localStorage on login", error);
        }
        ...
        if (foundUser) {
            ...
            throw new Error('User not found. Try admin, varsity, or novice');
        }
    };
    const logout = ()=>{
        setUser(null);
...
//# sourceMappingURL=src_46edfc05._.js.map