...
"[project]/node_modules/cssstyle/lib/allWebkitProperties.js [app-client] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/cssstyle/lib/allExtraProperties.js [app-client] (ecmascript)": (function(__turbopack_context__) {
 ...
 * This file contains all implemented properties that are not a part of any
 * current specifications or drafts, but are handled by browsers nevertheless.
 */ const allWebkitProperties = __turbopack_context__.r("[project]/node_modules/cssstyle/lib/allWebkitProperties.js [app-client] (ecmascript)");
...
"[project]/node_modules/cssstyle/lib/generated/allProperties.js [app-client] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/cssstyle/lib/generated/implementedProperties.js [app-client] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/cssstyle/lib/utils/strings.js [app-client] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/cssstyle/lib/parsers.js [app-client] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ "use strict";
const { resolve: resolveColor, utils } = __turbopack_context__.r("[project]/node_modules/@asamuzakjp/css-color/dist/cjs/index.cjs [app-client] (ecmascript)");
const { asciiLowercase } = __turbopack_context__.r("[project]/node_modules/cssstyle/lib/utils/strings.js [app-client] (ecmascript)");
...
exports.parseFunction = function parseFunction(val) {
    ...
    if (functionRegEx.test(val) && val.endsWith(")")) {
        ...
        const value = val.replace(new RegExp(`^${name}\\(`), "").replace(/\)$/, "").trim();
        return {
            name,
            value
        };
...
"[project]/node_modules/cssstyle/lib/generated/properties.js [app-client] (ecmascript)": (function(__turbopack_context__) {
...
// autogenerated - 2025-06-25
// https://www.w3.org/Style/CSS/all-properties.en.html
var external_dependency_parsers_0 = __turbopack_context__.r("[project]/node_modules/cssstyle/lib/parsers.js [app-client] (ecmascript)");
var external_dependency_strings_1 = __turbopack_context__.r("[project]/node_modules/cssstyle/lib/utils/strings.js [app-client] (ecmascript)");
...
font_export_parse = function parse(v) {
    ...
    if (fontBlockB) {
        ...
        const revParts = [
            ...external_dependency_parsers_0.splitValue(fontBlockA.trim())
        ].reverse();
        const revFontFamily = [];
        const properties = [
            "font-style",
...
"[project]/node_modules/cssstyle/lib/utils/camelize.js [app-client] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/cssstyle/lib/utils/propertyDescriptors.js [app-client] (ecmascript)": (function(__turbopack_context__) {

var { g: global, __dirname, m: module, e: exports } = __turbopack_context__;
{
"use strict";
const prepareValue = __turbopack_context__.r("[project]/node_modules/cssstyle/lib/parsers.js [app-client] (ecmascript)").prepareValue;
...
"[project]/node_modules/cssstyle/lib/CSSStyleDeclaration.js [app-client] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ "use strict";
const CSSOM = __turbopack_context__.r("[project]/node_modules/cssstyle/node_modules/rrweb-cssom/lib/index.js [app-client] (ecmascript)");
const allExtraProperties = __turbopack_context__.r("[project]/node_modules/cssstyle/lib/allExtraProperties.js [app-client] (ecmascript)");
const allProperties = __turbopack_context__.r("[project]/node_modules/cssstyle/lib/generated/allProperties.js [app-client] (ecmascript)");
const implementedProperties = __turbopack_context__.r("[project]/node_modules/cssstyle/lib/generated/implementedProperties.js [app-client] (ecmascript)");
const generatedProperties = __turbopack_context__.r("[project]/node_modules/cssstyle/lib/generated/properties.js [app-client] (ecmascript)");
const { hasVarFunc, parseKeyword, parseShorthand, prepareValue, splitValue } = __turbopack_context__.r("[project]/node_modules/cssstyle/lib/parsers.js [app-client] (ecmascript)");
const { dashedToCamelCase } = __turbopack_context__.r("[project]/node_modules/cssstyle/lib/utils/camelize.js [app-client] (ecmascript)");
const { getPropertyDescriptor } = __turbopack_context__.r("[project]/node_modules/cssstyle/lib/utils/propertyDescriptors.js [app-client] (ecmascript)");
const { asciiLowercase } = __turbopack_context__.r("[project]/node_modules/cssstyle/lib/utils/strings.js [app-client] (ecmascript)");
/**
...
//# sourceMappingURL=node_modules_cssstyle_lib_208cc332._.js.map