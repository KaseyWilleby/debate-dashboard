...
function initializeFirebase() {
    ...
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getApps"])().length) {
        ...
        firebaseApp = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getApp"])();
    }
...
async function lookupUserByUsername(auth, firestore, username) {
    try {
    ...
    const localUser = defaultUsers.find((u)=>u.username.toLowerCase() === username.toLowerCase());
    if (!localUser) {
        return null;
    }
    try {
        const userDocRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, 'users', localUser.id);
        ...
        // If user is in default list but not in Firestore, fall back to local data.
        return localUser;
    } catch (serverError) {
        ...
        // It's important to re-throw the original error or the new contextual one
        // so that the calling code knows the operation failed.
...
_s(AuthProvider, "dkL25NO9YxoFJD8Q129XaaY7k48=", false, function() {
    return [
...
//# sourceMappingURL=src_3f2b87c6._.js.map