...
_s5(useMemoFirebase, "nwk+m61qLgjDVUp4IGV/072DDN4=");
var _c;
...
function AllUsersFetcher({ children, onData }) {
    ...
    const usersCollectionRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AllUsersFetcher.useMemo[usersCollectionRef]": ()=>firestore ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(firestore, 'users') : null
    }["AllUsersFetcher.useMemo[usersCollectionRef]"], [
        firestore
    ]);
    const { data: allUsersData, isLoading: areUsersLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$firestore$2f$use$2d$collection$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCollection"])(usersCollectionRef);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AllUsersFetcher.useEffect": ()=>{
...
_s(AllUsersFetcher, "ohvOQV1qUDUcC2ernIcXxHavLV8=", false, function() {
    return [
...
function AuthProvider({ children }) {
    _s1();
    const { user: firebaseUser, isUserLoading: isFirebaseUserLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$auth$2f$use$2d$user$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUser"])();
    ...
    const [areUsersLoading, setAreUsersLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const userDocRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AuthProvider.useMemo[userDocRef]": ()=>firestore && firebaseUser ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, "users", firebaseUser.uid) : null
    }["AuthProvider.useMemo[userDocRef]"], [
        firestore,
        firebaseUser
    ]);
    // useDoc fetches the user profile from Firestore
    const { data: fetchedUser, isLoading: isAppUserLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$firestore$2f$use$2d$doc$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDoc"])(userDocRef);
    ...
    const handleAllUsersData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[handleAllUsersData]": (users, isLoading)=>{
            setAllUsers(users);
            setAreUsersLoading(isLoading);
        }
    }["AuthProvider.useCallback[handleAllUsersData]"], []);
    const isLoading = isFirebaseUserLoading || !!firebaseUser && isAppUserLoading || appUser?.role === 'admin' && areUsersLoading;
    const login = async (credentials)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$non$2d$blocking$2d$login$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initiateEmailSignIn"])(auth, credentials.email, credentials.password || 'password123');
    ...
    const logout = async ()=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$non$2d$blocking$2d$login$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initiateSignOut"])(auth);
    ...
    const signUp = async (credentials)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$non$2d$blocking$2d$login$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initiateEmailSignUp"])(auth, firestore, credentials.email, credentials.password || 'password123', credentials.name, credentials.role);
            router.push('/dashboard/welcome');
        } catch (error) {
    ...
    const providerContent = appUser?.role === 'admin' ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AllUsersFetcher, {
...
_s1(AuthProvider, "3eeRghBtbTNpz3w0UyfzRvcle1A=", false, function() {
    return [
...
var _c, _c1;
__turbopack_context__.k.register(_c, "AllUsersFetcher");
...
__turbopack_context__.s({
    ...
    "initiateSignOut": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$non$2d$blocking$2d$login$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initiateSignOut"]),
...
__turbopack_context__.s({
    ...
    "initiateSignOut": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__["initiateSignOut"]),
...
//# sourceMappingURL=src_3801ca47._.js.map