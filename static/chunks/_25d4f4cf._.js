...
function DashboardPage() {
    ...
    const { sessions, isMounted } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$notification$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNotifications"])();
    const { user, allUsers: users } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
        ...
        "DashboardPage.useEffect": ()=>{
            if ("TURBOPACK compile-time truthy", 1) {
                ...
                try {
                    ...
                    const parsedTournaments = storedTournaments ? JSON.parse(storedTournaments) : [];
                ...
                try {
                    ...
                    const parsedSpeeches = storedSpeeches ? JSON.parse(storedSpeeches) : [];
                    if (user) {
                        const userSpeeches = parsedSpeeches.filter({
                            "DashboardPage.useEffect.userSpeeches": (s)=>s.ownerId === user.id || (s.sharedWith || []).includes(user.id)
                        }["DashboardPage.useEffect.userSpeeches"]);
                        setSavedSpeeches(userSpeeches.sort({
                            "DashboardPage.useEffect": (a, b)=>new Date(b.date).getTime() - new Date(a.date).getTime()
                        }["DashboardPage.useEffect"]));
                    }
                } catch (error) {
                    console.error("Failed to parse speeches from localStorage", error);
                    setSavedSpeeches([]);
                }
            }
        }
...
_s(DashboardPage, "Du9i6L3fMcRtgAlHIE2MEt0ywTI=", false, function() {
    return [
...
//# sourceMappingURL=_25d4f4cf._.js.map