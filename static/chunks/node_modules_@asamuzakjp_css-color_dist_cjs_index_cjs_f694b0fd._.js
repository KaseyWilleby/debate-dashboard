...
"[project]/node_modules/@asamuzakjp/css-color/dist/cjs/index.cjs [app-client] (ecmascript)": (function(__turbopack_context__) {
...
// src/js/css-calc.ts
var import_css_calc4 = __turbopack_context__.r("[project]/node_modules/@csstools/css-calc/dist/index.cjs [app-client] (ecmascript)");
var import_css_tokenizer4 = __turbopack_context__.r("[project]/node_modules/@csstools/css-tokenizer/dist/index.cjs [app-client] (ecmascript)");
// src/js/cache.ts
var import_lru_cache = __turbopack_context__.r("[project]/node_modules/lru-cache/dist/commonjs/index.js [app-client] (ecmascript)");
// src/js/util.ts
var import_css_tokenizer3 = __turbopack_context__.r("[project]/node_modules/@csstools/css-tokenizer/dist/index.cjs [app-client] (ecmascript)");
// src/js/common.ts
...
var transformXyzD50ToLab = (xyz, skip = false)=>{
    ...
    const [f0, f1, f2] = xyzD50.map((val)=>val > LAB_EPSILON ? Math.cbrt(val) : (val * LAB_KAPPA + HEX) / LAB_L);
...
var parseColorFunc = (value, opt = {})=>{
    ...
    if (cs === "srgb-linear") {
        ...
        if (d50) {
            [x, y, z] = transformMatrix(MATRIX_D65_TO_D50, [
                x,
                y,
                z
            ], true);
        ...
        if (!d50) {
            [x, y, z] = transformMatrix(MATRIX_D50_TO_D65, [
                x,
                y,
                z
            ], true);
...
// src/js/css-var.ts
var import_css_tokenizer = __turbopack_context__.r("[project]/node_modules/@csstools/css-tokenizer/dist/index.cjs [app-client] (ecmascript)");
var { CloseParen: PAREN_CLOSE, Comment: COMMENT, EOF, Ident: IDENT, Whitespace: W_SPACE } = import_css_tokenizer.TokenType;
...
function resolveVar(value, opt = {}) {
    ...
    const tokens = (0, import_css_tokenizer.tokenize)({
        css: value
    });
...
var import_css_color_parser = __turbopack_context__.r("[project]/node_modules/@csstools/css-color-parser/dist/index.cjs [app-client] (ecmascript)");
var import_css_parser_algorithms = __turbopack_context__.r("[project]/node_modules/@csstools/css-parser-algorithms/dist/index.cjs [app-client] (ecmascript)");
var import_css_tokenizer2 = __turbopack_context__.r("[project]/node_modules/@csstools/css-tokenizer/dist/index.cjs [app-client] (ecmascript)");
var { CloseParen: PAREN_CLOSE2, Comment: COMMENT2, Dimension: DIM, EOF: EOF2, Function: FUNC, Ident: IDENT2, Number: NUM2, OpenParen: PAREN_OPEN, Percentage: PCT2, Whitespace: W_SPACE2 } = import_css_tokenizer2.TokenType;
...
function extractOriginColor(value, opt = {}) {
    ...
    if (REG_COLOR_CAPT.test(value)) {
        ...
        if (format === VAL_SPEC) {
            const tokens = (0, import_css_tokenizer2.tokenize)({
                css: restValue
            });
...
// src/js/util.ts
var { CloseParen: PAREN_CLOSE3, Comma: COMMA, Comment: COMMENT3, Delim: DELIM, EOF: EOF3, Function: FUNC2, Ident: IDENT3, OpenParen: PAREN_OPEN2, Whitespace: W_SPACE3 } = import_css_tokenizer3.TokenType;
var NAMESPACE5 = "util";
var DEC3 = 10;
var HEX3 = 16;
var DEG2 = 360;
...
var splitValue = (value, opt = {})=>{
    ...
    const tokens = (0, import_css_tokenizer3.tokenize)({
        css: value
    });
    let nest = 0;
    let str = "";
...
// src/js/css-calc.ts
var { CloseParen: PAREN_CLOSE4, Comment: COMMENT4, Dimension: DIM2, EOF: EOF4, Function: FUNC3, OpenParen: PAREN_OPEN3, Whitespace: W_SPACE4 } = import_css_tokenizer4.TokenType;
...
var serializeCalc = (value, opt = {})=>{
    ...
    const items = (0, import_css_tokenizer4.tokenize)({
        css: value
    }).map((token)=>{
...
var cssCalc = (value, opt = {})=>{
    ...
    const tokens = (0, import_css_tokenizer4.tokenize)({
        css: value
    });
...
//# sourceMappingURL=node_modules_%40asamuzakjp_css-color_dist_cjs_index_cjs_f694b0fd._.js.map