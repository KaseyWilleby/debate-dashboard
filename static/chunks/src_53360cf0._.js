...
const firebaseConfig = {
    "projectId": "studio-7478337045-1ef84",
    "appId": "1:762669212471:web:6c4a62ce1af2ed505170b2",
    "apiKey": "AIzaSyBXid_skleJ55KL6Rc_0NJVRHWamNAYzVU",
    "authDomain": "studio-7478337045-1ef84.firebaseapp.com",
    "measurementId": "",
    "messagingSenderId": "762669212471"
};
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useCollection.useEffect": ()=>{
            if (memoizedTargetRefOrQuery && !memoizedTargetRefOrQuery.__memo) {
                const err = new Error('useCollection received a query or reference that was not created with useMemoFirebase. This will cause infinite render loops.');
                setError(err);
                console.error(err);
                setIsLoading(false);
                return;
...
const useUser = ()=>{
    ...
    const [userState, setUserState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useUser.useEffect": ()=>{
            ...
            const unsubscribe = auth.onAuthStateChanged({
                "useUser.useEffect.unsubscribe": (firebaseUser)=>{
                    setUserState({
                        user: firebaseUser,
                        isUserLoading: false,
                        userError: null
                ...
                "useUser.useEffect.unsubscribe": (error)=>{
...
_s(useUser, "E3VFcX/MIJzNNqYuBe59vGq/9Ok=", false, function() {
    return [
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/src/firebase/index.ts [app-client] (ecmascript) <module evaluation>"); // Using alias to avoid naming collision
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$auth$2f$use$2d$user$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/firebase/auth/use-user.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/firebase/provider.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$non$2d$blocking$2d$login$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/firebase/non-blocking-login.tsx [app-client] (ecmascript)");
;
...
const CURRENT_USER_STORAGE_KEY = 'work-session-user';
// This is a static list for mapping Firebase UIDs to app-specific user profiles.
const allUsers = [
    {
        id: '1',
        name: 'Admin Adam',
...
function AuthProvider({ children }) {
    _s();
    const { user: firebaseUser, isUserLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$auth$2f$use$2d$user$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUser"])();
    const firebaseAuth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const login = (credentials)=>{
        const userToLogin = allUsers.find((u)=>u.username.toLowerCase() === credentials.username.toLowerCase());
        if (userToLogin) {
            // We are not creating real users, so we'll just use anonymous sign-in for a session
            // and link it to our mock user profile locally.
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$non$2d$blocking$2d$login$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initiateAnonymousSignIn"])(firebaseAuth);
            localStorage.setItem(CURRENT_USER_STORAGE_KEY, JSON.stringify(userToLogin));
            setAppUser(userToLogin);
            router.push('/dashboard/welcome');
        } else {
            throw new Error('User not found. Try one of: admin, varsity, novice, Mr.Willeby, vera, nate');
        }
    };
    const logout = ()=>{
...
_s(AuthProvider, "tuM/CusymFBG3+ZzkOvx1SE1XY0=", false, function() {
    return [
...
function NotificationProvider({ children }) {
    ...
    const userSessionsQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemoFirebase"])({
        "NotificationProvider.useMemoFirebase[userSessionsQuery]": ()=>{
    ...
    const { data: userSessions, isLoading: sessionsLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$firestore$2f$use$2d$collection$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCollection"])(userSessionsQuery);
    const adminSessionsQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemoFirebase"])({
        "NotificationProvider.useMemoFirebase[adminSessionsQuery]": ()=>{
    ...
    const { data: adminSessions, isLoading: adminLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$firestore$2f$use$2d$collection$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCollection"])(adminSessionsQuery);
    const sessions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "NotificationProvider.useMemo[sessions]": ()=>{
    ...
    const notifications = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "NotificationProvider.useMemo[notifications]": ()=>{
            if (!user || !sessions || sessions.length === 0) return [];
            const newNotifications = [];
            sessions.forEach({
                "NotificationProvider.useMemo[notifications]": (session)=>{
                    // Only create notifications for sessions the user is actually a part of
                    if (session.hostId !== user.id && session.clientId !== user.id) {
                        return;
                    }
            ...
            return newNotifications.sort({
                "NotificationProvider.useMemo[notifications]": (a, b)=>new Date(b.timestamp).getTime() - new Date(a.timestamp).getTime()
            }["NotificationProvider.useMemo[notifications]"]);
        }
    }["NotificationProvider.useMemo[notifications]"], [
        sessions,
    ...
    const updateSession = async (session)=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateDoc"])(sessionDocRef, {
                ...session
            });
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$error$2d$emitter$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["errorEmitter"].emit('permission-error', new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$errors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FirestorePermissionError"]({
    ...
    const isLoading = user?.role === 'admin' ? adminLoading || isAuthLoading : sessionsLoading || isAuthLoading;
    const value = {
        user,
        sessions,
        users: allUsers,
...
_s(NotificationProvider, "/JDbae47MpaeDqWzbjEhEm2cm4k=", false, function() {
    return [
...
__turbopack_context__.s({
    ...
    "getRoleBasedColor": (()=>getRoleBasedColor)
});
...
//# sourceMappingURL=src_53360cf0._.js.map