...
export type LearningResource = WebsiteResource | VideoResource;
...
export const debateEventsOrder = [
  'All Debate',
...
export const interpEventsOrder = [
...
export const debateResources: LearningResource[] = [
    {
    id: 'ld-intro',
    type: 'video',
...
export const speechResources: LearningResource[] = [
    {
    id: 'extemp-structure',
    type: 'video',
...
export const interpResources: LearningResource[] = [
    {
...
export const congressResources: LearningResource[] = [
    {
    id: 'congress-intro',
    type: 'video',
